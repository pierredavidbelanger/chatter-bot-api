    ...
    class ChatterBotFactory
    {
        public function create($type, $arg = null)
        {
            switch ($type)
            {
                ...
                {
                    return new _Cleverbot('http://www.cleverbot.com', 'http://www.cleverbot.com/webservicemin?uc=UseOfficialAPI&botapi=chatterbotapi', 26);
                }
                case ChatterBotType::JABBERWACKY:
                {
                    return new _Cleverbot('http://jabberwacky.com', 'http://jabberwacky.com/webservicemin?botapi=chatterbotapi', 20);
                }
